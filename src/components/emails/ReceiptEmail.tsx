...
export const ReceiptEmail = ({
  ...
  const total =
    //TODO +1 is equal transaction fees so implement shipment fees later
    products.reduce((acc, curr) => acc + curr.price, 0) + 1;

  return (
    <Html>
      <Head />
      <Preview>Votre facture de DigitalBrocante</Preview>
        ...
        <Container style={container}>
          ...
          <Section style={informationTable}>
            <Row style={informationTableRow}>
              ...
              <Column style={informationTableColumn}>
                <Text style={informationTableLabel}>ID de la commande</Text>
                <Link
                  style={{
                    ...informationTableValue,
                  }}
          ...
          <Text style={footerCopyright}>
            Copyright © 2023 DigitalBrocante Inc. <br />{" "}
