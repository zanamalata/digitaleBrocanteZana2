  ...
  return (
    <main className="relative lg:min-h-full">
      <div className="hidden lg:block h-80 overflow-hidden lg:absolute lg:h-full lg:w-1/2 lg:pr-4 xl:pr-12">
        {/* TODO change image coz its too big */}
        <Image
          fill
      ...
      <div>
        <div className="mx-auto max-w-2xl px-4 py-16 sm:px-6 sm:py-24 lg:grid lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8 lg:py-32 xl:gap-x-24">
          <div className="lg:col-start-2">
            ...
            {order._isPaid ? (
              // TODO change while shipment is implemented
              <p className="mt-2 text-base text-muted-foreground">
                Votre commande a été traitée et vos télechargements sont
                disponible ci-dessous. Nous avons envoyé la facture à{" "}
              ...
              // TODO sent confirmation email at product sent / translate / implement shipment
              <p className="mt-2 text-base text-muted-foreground">
                Nous vous remercions pour votre commande.
                <br /> Le vendeur prépare votre commande. <br />
                Nous vous enverrons un email de confirmation dès que le vendeur
                aura envoyé votre commande.
              </p>
            )}
